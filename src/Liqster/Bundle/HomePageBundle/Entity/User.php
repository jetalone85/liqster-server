 ...
 *
 * @ORM\Table(name="user")
 * @ORM\Entity(repositoryClass="Liqster\Bundle\HomePageBundle\Repository\UserRepository")
 */
class User extends BaseUser
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="Liqster\Bundle\HomePageBundle\Entity\Account", mappedBy="user")
     */
    private $account;
