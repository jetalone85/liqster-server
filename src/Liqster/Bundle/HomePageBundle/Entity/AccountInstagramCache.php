 ...
 * @ORM\Entity(repositoryClass="Liqster\Bundle\HomePageBundle\Repository\AccountInstagramCacheRepository")
 */
class AccountInstagramCache
{
    ...
    /**
     * @ORM\OneToOne(targetEntity="Liqster\Bundle\HomePageBundle\Entity\Account", inversedBy="accountInstagramCache")
